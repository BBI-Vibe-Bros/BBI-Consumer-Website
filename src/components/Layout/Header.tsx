...
const Header = () => {
  ...
  const navigation = [
    { 
      ...
      submenu: [
        { title: 'What is Medicare?', href: '/medicare/basics/what-is-medicare' },
        { title: 'Enrollment Periods', href: '/medicare/basics/enrollment-periods' },
        { title: 'Medicare Costs', href: '/medicare/basics/costs' },
    ...
    { 
      ...
      href: '/plans',
      submenu: [
        { title: 'Medicare Advantage', href: '/plans/advantage' },
        { title: 'Medicare Supplements', href: '/plans/supplement' },
        { title: 'Prescription Drug Plans', href: '/plans/prescription' },
        { title: 'Dental & Vision', href: '/plans/dental' },
      ] 
    },
    { 
      title: 'Why Choose Us',
    ...
    { 
      ...
      href: '/resources',
      submenu: [
        { title: 'Medicare Guides', href: '/resources/guides' },
        { title: 'Medicare Blog', href: '/blog' },
        { title: 'Medicare Videos', href: '/videos' },
        { title: 'Medicare FAQs', href: '/resources/faqs' },
      ] 
    }
  ];
        ...
        <div className="flex justify-between items-center py-4">
          ...
          <div className="flex-shrink-0">
            <Link to="/" className="flex items-center">
              <img 
                src="public/lovable-uploads/3fcf1838-6d6d-4441-a795-6e4d4e7b6699.png" 
                            ...
                            {item.submenu.map((subItem) => (
                              <li key={subItem.title} className="row-span-1">
                                <NavigationMenuLink asChild>
                                  <Link 
                                    to={subItem.href} 
                                    className="block p-2 hover:bg-muted rounded-md text-lg"
                                  >
                                    {subItem.title}
                                  </Link>
                                </NavigationMenuLink>
          ...
          <div className="hidden lg:block">
            <Button className="bg-bb-yellow hover:bg-bb-yellow/90 text-bb-dark font-bold text-lg">
