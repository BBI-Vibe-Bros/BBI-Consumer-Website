      ...
      <div className="rounded-xl overflow-hidden bg-bb-blue">
        <div className="flex flex-col md:flex-row">
          <div className="p-4 md:p-6 md:w-1/2 flex flex-col justify-center">
            <h2 className="text-xl md:text-2xl font-bold mb-2 md:mb-3 text-white">Get Your Free Medicare Guide</h2>
            <p className="text-sm md:text-base mb-4 md:mb-5 leading-relaxed text-white/90">
