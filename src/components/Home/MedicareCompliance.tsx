...
const MedicareCompliance = () => {
  return <div className="medicare-disclaimer bg-gray-100 border border-gray-300 mx-auto max-w-5xl my-0 px-[7px]">
      <div className="p-4 py-0 px-[25px]">
        <h3 className="font-semibold mb-2 text-base">Medicare Compliance Statement</h3>
        <p className="text-sm lg:text-sm px-0 mx-0 my-0">
        ...
        <p className="text-sm mt-2 lg:text-sm">
