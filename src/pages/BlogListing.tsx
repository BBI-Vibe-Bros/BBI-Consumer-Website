    ...
    <Layout>
      ...
      <div className="container mx-auto px-6 py-12">
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-bb-dark">Medicare Insurance Blog</h1>
          <p className="text-xl text-gray-700 mt-4 max-w-3xl mx-auto">
            Stay informed with the latest updates, tips, and guidance on Medicare insurance
          </p>
        </div>
                ...
                return (
                  ...
                  >
                    ...
                    <div className="p-5 flex-grow">
                      ...
                      <p className="text-gray-700 line-clamp-3">{fields.excerpt}</p>
                    </div>
